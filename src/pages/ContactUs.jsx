...
const ContactUs = () => {
  ...
  return (
    <div className="container mx-auto px-5 md:px-10 mb-20     my-10 p-6 mt-[72px]">
      ...
      <h2 className="my-8 font-bold text-2xl dark:text-white">Contact Us</h2>
      <div className="flex flex-col-reverse lg:flex-row gap-6 mt-10 ">
        {/* Right section: Address info */}
        <div className="w-full lg:w-1/2 flex flex-col sm:flex-row gap-8 space-y-2 justify-center text-black dark:text-white">
