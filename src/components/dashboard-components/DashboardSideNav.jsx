...
const DashboardSideNav = ({ toggleSidebar, isOpen }) => {
  return (
    <>
      <nav
        className={`fixed z-10 bg-black/5 dark:bg-white/20 h-[calc(100vh-64px)] flex-shrink-0 transform transition-transform duration-500 ${
      ...
      >
        <div className="flex flex-col">
          ...
          <NavLink
            to="/"
            className=" mt-8 flex items-center gap-2 px-4 py-2 bg-black text-white hover:bg-black/80 dark:bg-white dark:text-black hover:dark:bg-white/90 w-full justify-center"
          >
